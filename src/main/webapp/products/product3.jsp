...
<html>
<head>
  <title>OffWorld Clothes - Pants</title>
...
<div class="container">
  <h2 class="row-2 text-center">Pants</h2>
  <div class="row">
    <img class="col img-fluid" src="${pageContext.request.contextPath}/images/pants.png" alt="pants">
    <div class="container col">
      ...
      <form class="form-horizontal row" action="addToCart" method="post">
        <fieldset>
          ...
          <br>
          <p>$1.00</p>
          <input type="hidden" id="name" name="name" class="name" value="pants">
          <input type="hidden" id="price" name="price" class="price" value="1">
          <input type="hidden" id="img" name="img" class="img" value="${pageContext.request.contextPath}/images/pants.png">
          <div class="form-group">
            <div class="col-md-4">
